...
from core.base import SampleBase  # type: ignore
from core.matrix import import_matrix, load_matrix
...
# Fonts
font = graphics.Font()
font.LoadFont(os.path.join(ASSETS_DIR, "fonts/6x10.bdf"))
font1 = graphics.Font()
font1.LoadFont(os.path.join(ASSETS_DIR, "fonts/8x13B.bdf"))
font2 = graphics.Font()
font2.LoadFont(os.path.join(ASSETS_DIR, "fonts/6x9.bdf"))
...
# Audio Configuration
# red_alert_sound = "bindings/python/samples/REPLACE_WITH_YOUR_AUDIO.wav"  # Replace with your WAV file path
