...
class SampleBase(object):
    ...
    def process(self):
        ...
        self.matrix, self.canvas = load_matrix()
        try:
            # Start loop
...
class StopData:
    def __init__(self, stop_id, name, routes):
    ...
    def start(self, api_key, stops):
        self.worker = MTAWorker(
            configured_stop_ids=[self.stop_id],
            refresh_s=30.0,
            api_key=api_key,
